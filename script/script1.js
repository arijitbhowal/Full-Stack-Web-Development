document.getElementById("sendButton").addEventListener("click", function () {
    ...
    if (firstName === "") {
        document.getElementById("firstnameError").textContent = "Please supply the details";
    ...
    if (lastName === "") {
        document.getElementById("lastnameError").textContent = "Please supply the details";
    ...
    if (email === "") {
        document.getElementById("emailError").textContent = "Please supply the details";
    ...
    if (phone === "") {
        document.getElementById("phoneError").textContent = "Please supply the details";
    ...
    if (address === "") {
        document.getElementById("addressError").textContent = "Please supply the details";
    ...
    if (city === "") {
        document.getElementById("cityError").textContent = "Please supply the details";
    ...
    if (projectDescription === "") {
        document.getElementById("projectDescriptionError").textContent = "Please supply the details";
